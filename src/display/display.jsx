...
export default class Display extends React.Component {
    ...
    dragged(e, functionType){
      ...
      if (functionType === 'measure') {
        ...
        if(this.state.dimension) {
          for (let col of document.querySelectorAll("#dimension div .ddcontainer")) {
    ...
    clear(functionType){
      ...
      let selector = functionType === 'measure' ? "#measure div .ddcontainer" : "#dimension div .ddcontainer";
              ...
              <Row>
                ...
                <Col md={2}><label>
                    <input type="checkbox" onChange={(e) => {
                      ...
                      this.configureChart(this.state.data,  e.currentTarget.checked, e.currentTarget.checked )
                      }}></input>
                    <div class="slider"></div>
                  </label>
                  </Col>
          ...
          <div className="dimension-input">
              ...
              <div className="input">
                <DropTarget targetKey="input" onHit={(e) =>this.dragged(e, 'dimension')} >
                    <div>
                      { 
                        this.state.dimension && <div  className="column" key={this.state.dimension.name}>{this.state.dimension.name}</div>
                      }
                    </div>
              </DropTarget>
                  ...
                  { 
                    this.state.measures.length > 0 && 
                          ...
                          this.state.measures.map((measure) =>
                            <div  className="column" key={measure.name}>{measure.name}</div>
                          )
